...
typedef struct IEcoLab1VTbl {
    ...
    /* IEcoLab1 */
    int16_t (ECOCALLMETHOD *bucketSortInt)(/* in */ IEcoLab1Ptr_t me, /* in */ int* array, /* in */ int size);
    int16_t (ECOCALLMETHOD *bucketSortLong)(/* in */ IEcoLab1Ptr_t me, /* in */ long* array, /* in */ int size);
    int16_t (ECOCALLMETHOD *bucketSortFloat)(/* in */ IEcoLab1Ptr_t me, /* in */ float* array, /* in */ int size);
    int16_t (ECOCALLMETHOD *bucketSortDouble)(/* in */ IEcoLab1Ptr_t me, /* in */ double* array, /* in */ int size);
    int16_t (ECOCALLMETHOD *bucketSortLongDouble)(/* in */ IEcoLab1Ptr_t me, /* in */ long double* array, /* in */ int size);
