...
typedef enum tagECO_BUCKET_SORT_TYPE {
    ECO_BUCKET_SORT_INT32 = 0,
    ECO_BUCKET_SORT_LONG,
    ECO_BUCKET_SORT_FLOAT,
    ECO_BUCKET_SORT_DOUBLE,
    ECO_BUCKET_SORT_LONG_DOUBLE
} ECO_BUCKET_SORT_TYPE;
...
typedef struct IEcoLab1VTblEvents {
    ...
    /* IEcoLab1Events */
    int16_t (ECOCALLMETHOD *OnBucketSortDistribute)(/* in */ struct IEcoLab1Events* me,
                                                    /* in */ int32_t elementIndex,
                                                    /* in */ int32_t bucketIndex,
                                                    /* in */ ECO_BUCKET_SORT_TYPE typeId);
    int16_t (ECOCALLMETHOD *OnBucketSortBucketSort)(/* in */ struct IEcoLab1Events* me,
                                                    /* in */ int32_t bucketIndex,
                                                    /* in */ ECO_BUCKET_SORT_TYPE typeId);
    int16_t (ECOCALLMETHOD *OnBucketSortCompleted)(/* in */ struct IEcoLab1Events* me,
